...
export default [
  change(date(2024, 11, 22), <>Update <SpellLink spell={TALENTS_MONK.RUSHING_WIND_KICK_MISTWEAVER_TALENT}/> and <SpellLink spell={TALENTS_MONK.VIVACIOUS_VIVIFICATION_TALENT}/> for Midnight.</>, Vohrr),
