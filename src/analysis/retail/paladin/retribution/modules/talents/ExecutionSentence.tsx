...
export default class ExecutionSentence extends Analyzer {
  ...
  constructor(options: Options) {
    ...
    this.addEventListener(
      Events.damage.by(SELECTED_PLAYER).spell(SPELLS.EXECUTION_SENTENCE_APPLY_DAMAGE),
      this.executionSentenceDamage,
    );
    this.addEventListener(
      Events.damage.by(SELECTED_PLAYER).spell(SPELLS.EXECUTION_SENTENCE_FALL_DAMAGE),
      this.executionSentenceDamage,
    );
  }
