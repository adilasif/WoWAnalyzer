...
export default [  
  change(date(2025, 10, 9), <>Update multiple hero talent modules.</>, KYZ),
  change(date(2025, 10, 5), <>Update <SpellLink spell={TALENTS.EBON_MIGHT_TALENT}/> and <SpellLink spell={TALENTS.REGENERATIVE_CHITIN_TALENT}/> modules.</>, KYZ),
