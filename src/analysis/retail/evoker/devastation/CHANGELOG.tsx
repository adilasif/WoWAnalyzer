...
export default [
  change(date(2026, 1, 25), <>Add statistics for <SpellLink spell={TALENTS.STRAFING_RUN_TALENT}/>, <SpellLink spell={TALENTS.AZURE_SWEEP_TALENT}/> and <SpellLink spell={TALENTS.SHATTERING_STARS_TALENT}/>.</>, Vollmer),
